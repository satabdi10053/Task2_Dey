...
fact_visit.write.format("delta").mode("append").save("abfss://BF_Gold@basicfitete.dfs.core.windows.net/visit")

%SQL
CREATE TABLE Lakeflow_BF.BF_gold.fact_visit USING DELTA LOCATION 'abfss://BF_Gold@basicfitete.dfs.core.windows.net/visit';
